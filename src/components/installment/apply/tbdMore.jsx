...
class Tbd extends Component{
    ...
    render() {
        ...
        return (
            <Row id="tbdTotal">
                {
                    this.state.orderId===undefined?<div><Row style={{paddingBottom:'10px'}}>
                        <Col span={8} style={{textAlign:"right",paddingRight:"10px",fontSize:"14px",color:"#7F8FA4",marginBottom:"10px"}}>投保单1</Col>
                        ...
                        <TbdInput onRef={this.onRef.bind(this)} value={1} syx={this.syx.bind(this)} ></TbdInput></div>:''
                }
                {
                    //tbdList(clickArr,false,this)
                    this.state.orderId===undefined?tbdLists(clickArr,false,this):tbdLists(detailArr,true,this)
                    //this.state.addClick.map((i,k)=>{
                    //    //this.state.orderId===undefined?i=i
                    //                         return (
                    //            <Row key={'key'+i} id={'dels'+i}>
                    //                <div>
                    //                    <Row style={{paddingBottom:'10px'}}>
                    //                        <Col span={8} style={{textAlign:"right",paddingRight:"10px",fontSize:"14px",color:"#7F8FA4",marginBottom:"10px"}}>投保单{k+2}</Col>
                    //                        <Col span={2} push={10}>
                    //                            <Button type="danger" shape="circle" icon="minus" size="small" onClick={()=>{this.delete(i,k)}} />
                    //                        </Col>
                    //                    </Row>
                    //                    <TbdInput onRef={this.onRef.bind(this)} value={k+2} syx={this.syx.bind(this)}></TbdInput>
                    //                </div>
                    //
                    //            </Row>
                    //        )
